function parsePayload(payload, params) {
        ...
        static parse(bytes, parameters) {
            ...
            for (var i = 0; i < bytes.length; i++) {
                ...
                if(0x05 === bytes[i] && 0x04 === bytes[i+1]) {
                    ...
                    params.soil_water_tension1 = SoilSensor.convert_watermark(params.soil_moisture_raw1);
                    i = i+3;
                }
                ...
                if(0x06 === bytes[i] && 0x04 === bytes[i+1]) {
                    ...
                    params.soil_water_tension2 = SoilSensor.convert_watermark(params.soil_moisture_raw2);
                    i = i+3;
                }
    ...
    return SoilSensor.parse(payload);
}